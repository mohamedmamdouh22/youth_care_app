      ...
      listener: (context, state) {
        if (state is RequestLoading) {
          requestLoading = true;
           ...
           showTopSnackBar(
                context, const CustomSnackBar.success(message: 'Request Successfully Added !'));
          // go to news page
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: DropdownButton(
                        ...
                        hint: Text('${BlocProvider.of<RequestCubit>(context).dep}'),
                        onChanged: (value) => BlocProvider.of<RequestCubit>(context).setDepartement(value!)
                        ),
                  ),
                  const SizedBox(height: 20),
                  Padding(
                    ...
                    child: DropdownButton(
                        ...
                        hint: Text('${BlocProvider.of<RequestCubit>(context).stdferka}'),
                        onChanged: (value) => BlocProvider.of<RequestCubit>(context).setFerka(value!)
                        ),
                  ),
                  const SizedBox(height: 20),
                  CustomButton(
